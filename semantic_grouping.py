...
def semanic_grouping(X_train, y_train, X_test, y_test):
    ldemographics, lphysiometric, ladministrative, lclinical, lmedications, ldiabetismanagement = define_semantic_groups()
    ############
