...
def get_dimred(dataSource,
    ...
    def train_supervised(input_dim1, input_dim2, n_classes, trainloader):
    ...
    def test_supervised(input_dim1, input_dim2, n_classes, testloader):
    ...
    try:
        ...
        deepdimred_supervised = train_supervised(input_dim1, input_dim2, n_classes, trainloader)
    ...
    if X_test1 is not None:
        test_supervised(input_dim1, input_dim2, n_classes, testloader)
